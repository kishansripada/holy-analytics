                                 ...
                                 <ContextMenuTrigger>
                                    ...
                                    >
                                       ...
                                       <div className="flex w-full flex-row items-center justify-between">
                                          <div className="flex w-full flex-row items-center text-sm font-medium text-neutral-700">
                                             <Link
                                             ...
                                             <p className=" ml-auto text-xs text-neutral-500 ">Edited {timeSince(deployment.last_edited)} ago</p>
                                          </div>
                                       </div>
                                    </Link>
                                 </ContextMenuTrigger>
